<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\WWW\fastadmin\public/../application/admin\view\general\profile\index.html";i:1558594288;s:59:"D:\WWW\fastadmin\application\admin\view\layout\default.html";i:1557482263;s:56:"D:\WWW\fastadmin\application\admin\view\common\meta.html";i:1557482263;s:58:"D:\WWW\fastadmin\application\admin\view\common\script.html";i:1557482263;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="panel-body">
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.profile/update'); ?>">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <!--<div class="form-group">-->
                            <!--<label for="phone" class="control-label"><?php echo __('手机号'); ?>:</label>-->
                            <!--<input type="text" class="form-control" id="phone" name="row[phone]" value="<?php echo $phone; ?>" data-rule="required;phone"/>-->
                        <!--</div>-->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="old_password" class="control-label"><?php echo __('旧密码'); ?>:</label>
                            <input type="password" class="form-control" id="old_password" placeholder="<?php echo __('Leave password blank if dont want to change'); ?>" autocomplete="new-password" name="row[old_password]" value="" data-rule="password"/>
                        </div>
                        <div class="form-group">
                            <label for="password" class="control-label"><?php echo __('新密码'); ?>:</label>
                        ...
                        <div class="form-group">
                            <label for="check_password" class="control-label"><?php echo __('确认新密码'); ?>:</label>
                            <input type="password" class="form-control" id="check_password" placeholder="<?php echo __('Leave password blank if dont want to change'); ?>" autocomplete="new-password" name="row[check_password]" value="" data-rule="password"/>
                        </div>
