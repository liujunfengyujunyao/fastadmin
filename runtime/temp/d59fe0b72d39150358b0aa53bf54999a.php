<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\WWW\fastadmin\public/../application/admin\view\pay\order\edit.html";i:1558422417;s:59:"D:\WWW\fastadmin\application\admin\view\layout\default.html";i:1557482263;s:56:"D:\WWW\fastadmin\application\admin\view\common\meta.html";i:1557482263;s:58:"D:\WWW\fastadmin\application\admin\view\common\script.html";i:1557482263;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-order_id" data-rule="required" class="form-control" name="row[order_id]" type="text" value="<?php echo htmlentities($row['order_id']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Unique_order_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-unique_order_id" data-rule="required" class="form-control" name="row[unique_order_id]" type="text" value="<?php echo htmlentities($row['unique_order_id']); ?>">
        </div>
    </div>
    <div class="form-group">
